    ...
    <>
        ...
        <section id="banner">
            <div className="container-fluid">
                <div className="row">
                    <div className="col-lg-6 col-md-6 col-xl-6 col-xxl-6 col-xs-12 col-sm-12 my-5">
                        <div className="art-image text-center">
                            <img
                                className="banner-man img-fluid"
                                src="images/art.png"
                                alt="man-img"
                            />
                        </div>
                    </div>
                    <div className="col-lg-6 col-md-6 col-xl-6 col-xxl-6 col-xs-12 col-sm-12 art-bg">
        ...
        <section id="personal-details">
            <div className="container border my-3">
                ...
                <div className="row">
                    <div className="col-lg-6 col-md-6 col-xl-6 col-xxl-6 col-sm-12 col-xs-12 mt-2">
                        <div className="">
                            <label htmlFor="exampleFormControlInput1" className="form-label">
                                Address
                            </label>
                    ...
                    <div className="col-lg-3 col-md-3 col-xl-3 col-xxl-3 col-sm-12 col-xs-12 mt-2">
                        <div className="">
                            <label htmlFor="exampleFormControlInput1" className="form-label">
                                E-mail
                            </label>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-8 col-md-8 col-xl-8 col-xxl-8 col-sm-12 col-xs-12 mt-3">
                        <div>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-4 col-md-4 col-xl-4 col-xxl-4 col-sm-12 col-xs-12 mt-4">
                        <div className="">
                            <label htmlFor="exampleFormControlInput1" className="form-label">
                                Account Holder Name
                            </label>
                ...
                <div className="row">
                    <div className="col-lg-4 col-md-4 col-xl-4 col-xxl-4 col-sm-12 col-xs-12 mt-2">
                        <div className="">
                            <label htmlFor="exampleFormControlInput1" className="form-label">
                                IFSC Code
                            </label>
