                        ...
                        <div className="scholar">
                            <div className="scholar-main">
                                ...
                                <p className="scholar-sub">
                                    ...
                                    the need and poor
                                    <br />
                                    Persons for <i> Marriage of girls</i>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-6 col-md-6 col-xl-6 col-xxl-6 col-xs-12 col-sm-12 marraige mt-5">
                        <div className="scholar-image text-center">
                            <img
                                className=" banner-man img-fluid"
                                src="images/mrg-bg.png"
                                alt="man-img"
                            />
                        </div>
                    </div>
            ...
            <div className="container border my-3">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-4 col-md-4 col-xl-4 col-xxl-4 col-sm-12 col-xs-12 mt-3">
                        ...
                        <select className="form-select" id="floatingSelectGrid">
                            <option selected="">Marriage of Girl</option>
                            <option value={1}>One</option>
                            <option value={2}>Two</option>
                            <option value={3}>Three</option>
                        </select>
                    ...
                    <div className="col-lg-4 col-md-4 col-xl-4 col-xxl-4 col-sm-12 col-xs-12 mt-3">
                        <div className="">
                            ...
                            <input
                                ...
                                className="form-control scholar-form-input"
                                id="exampleFormControlInput1"
                                placeholder="Enter income in lacs"
                            />
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-4 col-xl-4 col-xxl-4 col-sm-12 col-xs-12 mt-3">
